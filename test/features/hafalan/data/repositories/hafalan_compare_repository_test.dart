...
void main() {
  ...
  group('HafalanCompareRepository', () {
    ...
    test('should return SetoranCompareResult when datasource call is successful',
        () async {
      // arrange
      when(
    ...
    test('should return Failure.network when DioException with connection error occurs',
        () async {
      // arrange
      when(
        () => mockDataSource.compare(
    ...
    test('should return Failure.server when DioException with response error occurs',
        () async {
      // arrange
      when(
        () => mockDataSource.compare(
    ...
    test('should return Failure.unknown when generic exception occurs',
        () async {
      // arrange
      when(
        () => mockDataSource.compare(
      ...
      result.fold(
        (failure) {
          ...
          expect((failure as UnknownFailure).message, contains('Something went wrong'));
        },
        (_) => fail('Should return failure'),
      );
    });
