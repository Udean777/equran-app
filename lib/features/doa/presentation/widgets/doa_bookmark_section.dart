...
class DoaBookmarkSection extends StatefulWidget {
  const DoaBookmarkSection({super.key, this.onEmptyStateChanged});

  final ValueChanged<bool>? onEmptyStateChanged;

  @override
  State<DoaBookmarkSection> createState() => _DoaBookmarkSectionState();
}

class _DoaBookmarkSectionState extends State<DoaBookmarkSection> {
  @override
