...
final suratListViewModelProvider =
    AutoDisposeStateNotifierProvider<SuratListViewModel, SuratListState>(
      (ref) {
        final vm = SuratListViewModel(ref.read(getSuratListProvider));
        unawaited(vm.load());
        return vm;
      },
    );
