...
/// Menggunakan Riverpod provider untuk manage state notifikasi.
class SettingsShalatNotifSection extends ConsumerWidget {
  const SettingsShalatNotifSection({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final isDark = context.isDark;
    final prefs = ref.watch(shalatNotifViewModelProvider);
    final vm = ref.read(shalatNotifViewModelProvider.notifier);
                ...
                children: [
                  _StepButton(
                    ...
                    onTap: () {
                      ...
                      unawaited(vm.setMenitSebelum(newVal));
