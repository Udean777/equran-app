abstract final class AppDimens {
  ...
  // Bottom sheet
  // ---------------------------------------------------------------------------
  static const double bottomSheetMinChildSize = 0.5;
  static const double bottomSheetMaxChildSize = 0.95;
  static const double bottomSheetInitialChildSize = 0.7;
  ...
  /// Padding horizontal standar untuk page content
  static const double pagePadding = 20;

  /// Padding horizontal untuk hero/header section
  static const double heroPadding = 24;

  /// Tinggi hero card di SuratListPage
  static const double heroCardHeight = 180;
